...
class WazuhClient:
    ...
    async def get_agents(self):
        """Agentes reales registrados en el Wazuh Manager.

        Antes se mezclaban 4 agentes ficticios (SRV-WEB-01, SRV-DB-PROD, WKST-CEO-01...)
        con los reales, y si la API fallaba se devolvían solo los ficticios. Ahora un
        fallo se propaga para que la interfaz muestre el error en vez de datos inventados.
        """
        r = await self.request("GET", "/agents", params={"limit": 500})
        r.raise_for_status()
